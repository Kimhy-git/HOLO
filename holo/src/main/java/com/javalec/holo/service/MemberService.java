...
//	public List<Dto> selectMember() throws Exception;
	...
	//notice
		...
		//댓글 삭제
		public void freeboard_submit(int post_id, int board, String title, String operator, String nick, String content, String img, String user_user_id)throws Exception;
}
